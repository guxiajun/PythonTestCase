...
def run():
    ...
    lib.ExeCmdCallBack(0,"CHECK, CounterGetTotal, 20, /data/videoEngine/data/Counters/iFrameSent0, >=,12.0")
    ...
    lib.ExeCmdCallBack(1,"CHECK, CounterGetTotal, 20, /data/videoEngine/data/Counters/iFrameSent0, >=,12.0")
    time.sleep(10)

    lib.ExeCmdCallBack(0, "setVideoProfileEx,960,720,5,1380")
    lib.ExeCmdCallBack(0, "CHECK, CounterGetTotal, 20, /data/videoEngine/data/Counters/iFrameSent0, <=,10.0")
    lib.ExeCmdCallBack(0, "setVideoProfileEx,380,180,30,500")
