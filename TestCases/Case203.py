...
def shortDesc():
    return "反复Disable/Enable Video"
def detailDesc():
    return "验证反复Disable/Enable Video后，Premium的运行情况"
def run():
    ...
    lib.ExeCmdCallBack(0, "CHECK, CounterGetTotal, 10, /data/videoEngine/data/Counters/iRenderFrames_00000002, ==, 0.0")
    lib.ExeCmdCallBack(0, "CHECK, CounterGetTotal, 10, /data/videoEngine/data/Counters/iRenderFrames_00000000, ==, 0.0")
    lib.ExeCmdCallBack(0, "enableVideo")
    i=lib.ExeCmdCallBack(0, "CHECK, CounterGetTotal, 10, /data/videoEngine/data/Counters/iRenderFrames_00000002, >=, 3.0")
    lib.ExeCmdCallBack(0, "CHECK, CounterGetTotal, 10, /data/videoEngine/data/Counters/iRenderFrames_00000000, >=, 3.0")
